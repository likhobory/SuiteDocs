...
В панели администратора выполните 
...
По умолчанию для фильтрации используются поля 
link:../../../../../user/introduction/user-interface/search/#_расширенный_фильтр[Расширенного фильтра^].
...
{{% notice tip %}}
Если субпанель можно настроить через интерфейс системы, то для настройки фильтров воспользуйтесь 
link:../../../../../admin/administration-panel/developer-tools/#_редактирование_форм_фильтров_модуля_и_формы_фильтра_дашлета[Студией^].
{{% /notice %}}
