...
weight: 30
aliases:
  - /8.x/admin/upgrading/upgrading-82x-versions/
---
...
== 5. Check for Manual Migration Tasks
...
*5.2.* If there are pending tasks, ensure the Messenger worker is running before starting them. See link:../../async-tasks/messenger-setup[Messenger Setup] for instructions.

*5.3.* Follow the instructions on the link:../../async-tasks/manual-migration-tasks[Manual Migration Tasks] page to run and monitor the tasks.
