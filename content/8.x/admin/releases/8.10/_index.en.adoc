...
*Documentation:* link:../../../user/daily-activities/notes-attachments[Notes] · link:../../../user/sales-relationships/document-management/[Documents]
...
*Documentation:* link:../../async-tasks/[Async Tasks] · link:../../async-tasks/manual-migration-tasks/[Manual Migration Tasks] · link:../../../developer/extensions/backend/async-tasks/[Developer Guide: Async Tasks]
...
*Documentation:* link:../../async-tasks/configuration/[Async Tasks Configuration]
...
Visit https://suitecrm.com/releases/[suitecrm.com/releases] for the appropriate upgrade package for your installation.
