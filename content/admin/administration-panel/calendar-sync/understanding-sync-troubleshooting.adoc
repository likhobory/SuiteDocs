...
For initial setup, see link:/admin/administration-panel/calendar-sync/admin-setup[Administrator Setup Guide] and link:/user/calendar-sync/user-guide[User Guide]. For CalDAV-specific details, see link:/user/calendar-sync/caldav-guide[CalDAV Provider Guide].
...
|Edit the Calendar Account, click *Authenticate* to re-authorize, and test connection again. See link:/user/calendar-sync/user-guide#_re_authorizing_oauth[Re-authorizing OAuth].
...
* If connection test failed, see link:/user/calendar-sync/user-guide#_test_connection_workflow[Test Connection Workflow] to re-test
...
* See link:/user/calendar-sync/caldav-guide[CalDAV Provider Guide] for CalDAV-specific configuration and troubleshooting
